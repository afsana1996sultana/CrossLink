...
<div class="card-body">
    ...
    <div class="section-body">
		<a href="#" class="btn btn-primary" data-toggle="modal" data-target="#add_submenu"><i class="fa fa-plus"></i>Add SubMenu</a> 
        <div class="row mt-4">
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                                ...
                                <tbody> 
                                    ...
                                    <tr class="odd">
										...
										<td>
                                            @if($submenu->status==1)
                                            <div>
                                              <span class="badge badge-success">{{$submenu->s_name}}</span>
                                            </div>
                                            @else($submenu->status==2)
                                            <div>
                                              <span class="badge badge-danger">{{$submenu->s_name}}</span>
                                            </div>
                                            @endif
                                        </td>
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><i class="fa fa-edit">Add SubMenu</i></h5>
					...
					<div class="row">
						<div class="col-sm-12">
							<div class="input-group mb-4">
								...
								<label class="col-form-label">Submenu Name:&nbsp;</label>
								<input type="text" class="form-control" id="eSubmenuName" name="txtSubmenuName">
							</div>
						</div>
